...
import {
    SiRadixui, SiZod, SiAxios, SiReactquery,
    // SiNextauth,
    // SiI18next,
    // SiAmazonaws,
    // SiHeroicons,
    ...
    // SiMoment,
    // SiMicrosoftexcel,
    SiTrpc, SiSwiper, SiGreensock, SiAlgolia, SiFfmpeg,
    SiDaisyui,
    SiChartdotjs,
    SiAuth0
} from 'react-icons/si';
...
export const STACKS: stacksProps = {
    ...
    NextAuth: <Image src={'/icons/nextauth.png'} width={iconSize} height={iconSize} alt='nextauth'
                     className='text-black dark:text-white'/>,
    i18next: <Image src={'/icons/i18next.avif'} width={iconSize} height={iconSize} alt='i18next'
    ...
    Zustand: <Image src={'/icons/zustand.svg'} width={iconSize} height={iconSize} alt='zustand'/>,
